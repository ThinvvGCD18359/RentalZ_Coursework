...
const rentSchema = yup.object({
    ...
    price: yup.number().moreThan(0, 'Price cannot be 0').required(),
    furniture: yup.string(),
    notes: yup.string().max(255, "Notes can only be up to 255 characters"),
    reporter: yup.string().min(4, "Name must be at least 4 characters long").required(),
});
